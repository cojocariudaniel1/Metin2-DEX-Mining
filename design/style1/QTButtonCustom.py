...
class Button(QPushButton):
    def __init__(self, text, func, parent=None, ):
        ...
        self.default_style = ("#QButtonCustom {border: 1px solid gray; border-radius: 10px; background-color: red; "
                              "color: white;}")
        ##
        ...
        self.using_default = ("#QButtonCustom {border: 1px solid gray; border-radius: 10px; background-color: red; "
                              "color: white;}")

        self.working_style = ("#QButtonCustom {border: 1px solid gray; border-radius: 10px; background-color: green; "
                              "color: white;}")
        # Basic settings
        self.setText(text)
        self.setStyleSheet(self.default_style)
        self.setFont(QtGui.QFont("Helvetica", 17))
        ##
    ...
    def restore_style(self):
        self.setStyleSheet(self.using_default)
